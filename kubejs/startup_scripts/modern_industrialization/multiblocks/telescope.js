...
MIMachineEvents.registerMachines((event) => {
    const tungstensteelMachineCasing = event.memberOfBlock(
        mi('tungstensteel_machine_casing')
    );
    const tungstensteelMachinePipeCasing = event.memberOfBlock(
        mi('tungstensteel_machine_casing_pipe')
    );
    ...
    const telescopeHatch = event.hatchOf(
        'item_input',
        'item_output',
        'energy_input',
        'fluid_input'
