...
MIMachineEvents.registerMachines(event => {
    ...
    const minecraftBlackStainedGlass = event.memberOfBlock('minecraft:black_stained_glass');
    const architectsPaletteRedstoneOreBricks = event.memberOfBlock('architects_palette:redstone_ore_bricks');
    const minecraftRedstoneTorch = event.memberOfBlock('minecraft:redstone_torch');
