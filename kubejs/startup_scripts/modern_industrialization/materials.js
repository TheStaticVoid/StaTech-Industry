...
MIMaterialEvents.addMaterials((event) => {
    event.createMaterial('Cobalt', 'cobalt', 0x0100b0, (builder) => {
        builder
            .materialSet('shiny')
            .addParts(
                'tiny_dust',
            ...
            .block('iron')
            .rawMetal('copper', true)
            .rawMetal('iron', false)
            .defaultRecipes();
    });

    event.createMaterial('Desh', 'desh', 0xe9ba5d, (builder) => {
        builder
            .hardness('average')
            .addParts(
                'plate',
            ...
            .block('iron')
            .rawMetal('copper', true)
            .rawMetal('copper', false)
            .defaultRecipes();
    });

    event.createMaterial('Ostrum', 'ostrum', 0xbd7666, (builder) => {
        builder
            .hardness('average')
            .addParts(
                'plate',
    ...
    event.createMaterial('Calorite', 'calorite', 0xb63044, (builder) => {
        builder
            .hardness('hard')
            .addParts(
                'plate',
    ...
    event.createMaterial('Zinc', 'zinc', 0xb9e9c1, (builder) => {
        builder
            .hardness('soft')
            .addParts(
                'rod',
    ...
    event.createMaterial('Clay', 'clay', 0xa3acc7, (builder) => {
        builder
            .hardness('soft')
    ...
    event.createMaterial('Stone', 'stone', 0x767676, (builder) => {
        builder.hardness('hard').addParts('dust', 'tiny_dust');
    });

    event.createMaterial('Dark Ashes', 'dark_ashes', 0x292828, (builder) => {
        builder.hardness('hard').addParts('dust', 'tiny_dust');
    });

    event.createMaterial('Calcite', 'calcite', 0xefedf0, (builder) => {
        builder.hardness('average').addParts('dust');
    });

    event.createMaterial('Tuff', 'tuff', 0x8a8774, (builder) => {
        builder.hardness('average').addParts('dust');
    });

    event.createMaterial('Fluorite', 'fluorite', 0xe4ed9b, (builder) => {
        builder
            .hardness('average')
            .addParts('dust', 'tiny_dust')
            .ore({
    ...
    event.createMaterial('Enderium', 'enderium', 0x105e51, (builder) => {
        builder
            .hardness('hard')
            .addParts(
                'ingot',
    ...
    event.createMaterial('Moon Ice', 'moon_ice', 0x62bbf7, (builder) => {
        builder
            .hardness('hard')
            .addParts('dust', 'tiny_dust')
            .ore({
    ...
    event.createMaterial('Sky Bronze', 'sky_bronze', 0xa47b48, (builder) => {
        builder
            .hardness('hard')
            .addParts('plate')
    ...
    event.createMaterial('Sky Steel', 'sky_steel', 0x262726, (builder) => {
        builder
            .hardness('hard')
            .addParts('plate')
    ...
    event.createMaterial('Sapphire', 'sapphire', 0x4873f2, (builder) => {
        builder
            .hardness('hard')
            .materialSet('shiny')
    ...
    event.createMaterial('Peridot', 'peridot', 0x59f261, (builder) => {
        builder
            .hardness('hard')
            .materialSet('shiny')
            .addParts('dust', 'crushed_dust', 'gem')
