...
ServerEvents.recipes((event) => {
    ...
    event
        .shaped(mt('large_chemical_reactor'), ['PRP', 'UHU', 'PCP'], {
    ...
    event
        .shaped(mt('large_scale_assembler'), ['TGT', 'MAP', 'TCT'], {
    ...
    // -- BULK COMPACTOR -- //
    event
        .shaped(mt('bulk_compactor'), ['PDP', 'MCM', 'PHP'], {
    ...
    // -- BLAST ALLOY SMELTER -- //
    event
        .shaped(mt('blast_alloy_smelter'), ['CTC', 'CAC', 'KPK'], {
    ...
    event
        .shaped(mt('industrial_mixing_machine'), ['PTP', 'BMB', 'PLP'], {
    ...
    event
        .shaped(mt('oversized_electrolysis_chamber'), ['PMP', 'BEB', 'CLC'], {
            L: mi('large_advanced_pump'),
            B: kj('borosilicate_glass'),
    ...
    event
        .shaped(mt('grand_mass_centrifuge'), ['MPM', 'TCT', 'MUM'], {
    ...
    // -- MULTI-CUTTER -- //
    event
        .shaped(mt('multi_cutter'), ['MBM', 'CHC', 'MUM'], {
    ...
    event
        .shaped(mt('high_capacity_packer'), ['MDM', 'PAP', 'MHM'], {
            A: mi('conveyor'),
            D: mi('digital_circuit'),
            M: mi('advanced_motor'),
    ...
    event
        .shaped(mt('high_capacity_unpacker'), ['MAM', 'UDU', 'CHC'], {
            A: mi('conveyor'),
            D: mi('digital_circuit'),
            M: mi('advanced_motor'),
    ...
    event
        .shaped(mt('colossal_blast_furnace'), ['PQP', 'EHE', 'CSC'], {
    ...
    event
        .shaped(mt('large_polarization_machine'), ['MDM', 'NPN', 'RHR'], {
            P: mi('polarizer'),
            D: mi('digital_circuit'),
            M: mi('advanced_motor'),
    ...
    // -- ARRAYED WIREMILL -- //
    event
        .shaped(mt('arrayed_wiremill'), ['MDM', 'WHW', 'MLM'], {
