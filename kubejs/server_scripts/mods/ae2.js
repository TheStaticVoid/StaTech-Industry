...
ServerEvents.recipes((event) => {
    ...
    // -- BLANK PATTERN -- //
    event
        .shaped(ae('blank_pattern'), ['QGQ', 'GCG', 'SSS'], {
            Q: ae('quartz_glass'),
            G: '#c:dusts/glowstone',
    ...
    event
        .shaped(ae('crystal_resonance_generator'), ['ACA', 'FHF', 'AEA'], {
            A: '#c:plates/aluminum',
    ...
    // -- ME QUANTUM RING -- //
    event
        .shaped(ae('quantum_ring'), ['SLS', 'ECF', 'SLS'], {
            S: '#c:plates/aluminum',
            L: ae('logic_processor'),
            E: ae('engineering_processor'),
            C: ae('energy_cell'),
    ...
    // -- MATTER CONDENSER -- //
    event
        .shaped(ae('condenser'), ['SGS', 'GFG', 'SGS'], {
            S: '#c:plates/aluminum',
            G: '#c:glass_blocks',
            F: ae('fluix_dust'),
        })
    ...
    // -- CRAFTING UNIT -- //
    event
        .shaped(ae('crafting_unit'), ['SCS', 'FLF', 'SCS'], {
            S: '#c:plates/aluminum',
            C: ae('calculation_processor'),
            F: ae('fluix_glass_cable'),
            L: ae('logic_processor'),
    ...
    // -- ME PATTERN PROVIDER -- //
    event
        .shaped(ae('pattern_provider'), ['SCS', 'A F', 'SCS'], {
            S: '#c:plates/aluminum',
    ...
    // -- MOLECULAR ASSEMBLER -- //
    event
        .shaped(ae('molecular_assembler'), ['SGS', 'AWF', 'SGS'], {
            S: '#c:plates/aluminum',
            G: ae('quartz_glass'),
            A: ae('annihilation_core'),
    ...
    // -- ENTROPY MANIPULATOR -- //
    event
        .shaped(ae('entropy_manipulator'), ['FC ', 'ES ', '  S'], {
            F: ae('fluix_crystal'),
            C: ae('energy_cell'),
            E: ae('engineering_processor'),
            S: '#c:plates/aluminum',
    ...
    // -- COLOR APPLICATOR -- //
    event
        .shaped(ae('color_applicator'), ['FS ', 'SC ', '  E'], {
            F: ae('formation_core'),
            S: '#c:plates/aluminum',
    ...
    // -- MATTER CANNON -- //
    event
        .shaped(ae('matter_cannon'), ['SSF', 'CE ', 'S  '], {
            S: '#c:plates/aluminum',
            F: ae('formation_core'),
            C: ae('cell_component_4k'),
            E: ae('energy_cell'),
    ...
    // -- WIRELESS RECEIVER -- //
    event
        .shaped(ae('wireless_receiver'), [' F ', 'SQS', ' S '], {
            F: ae('fluix_pearl'),
            S: '#c:plates/aluminum',
            Q: ae('quartz_fiber'),
        })
    ...
    // -- WIRELESS BOOSTER -- //
    event
        .shaped('2x ' + ae('wireless_booster'), ['FQE', 'SSS'], {
            F: ae('fluix_dust'),
    ...
    // -- DENSE ENERGY CELL -- //
    event
        .shaped(ae('dense_energy_cell'), ['EEE', 'EHE', 'EEE'], {
            E: ae('energy_cell'),
    ...
    // -- NETWORK ANALYZER -- //
    event
        .shaped('ae2netanalyser:network_analyser', ['BAB', 'SHS', 'DSD'], {
            B: mi('bronze_plate'),
            A: mi('aluminum_plate'),
            S: mi('steel_plate'),
