...
ServerEvents.recipes((event) => {
    ...
    // -- FIRE CLAY DUST -- //
    event
        .shaped('3x ' + mi('fire_clay_dust'), ['BC ', 'CB '], {
            C: '#c:dusts/clay',
            B: '#c:dusts/brick',
        })
    ...
    // -- IRON HAMMER -- //
    event
        .shaped(mi('iron_hammer'), ['III', 'ISI', ' S '], {
            I: '#c:ingots/iron',
            S: '#c:rods/wooden',
        })
        .id(st('iron_hammer'));
    ...
    // -- STEEL HAMMER -- //
    event
        .shaped(mi('steel_hammer'), ['III', 'ISI', ' S '], {
            I: '#c:ingots/steel',
            S: '#c:rods/wooden',
        })
        .id(st('steel_hammer'));
    ...
    // -- DIAMOND HAMMER -- //
    event
        .shaped(mi('diamond_hammer'), ['DDD', 'DSD', ' S '], {
            D: '#c:gems/diamond',
            S: '#c:rods/wooden',
        })
    ...
    // -- BLOOD GENERATOR -- //
    event
        .shaped(mi('blood_generator'), ['RCR', 'THT', 'PCP'], {
    ...
    // -- BOSS CRUSHER -- //
    event
        .shaped(mi('boss_crusher'), ['RCR', 'PHP', 'MCM'], {
    ...
    event
        .shaped(mi('chemically_inert_ptfe_casing'), ['PPP', 'PGP', 'PPP'], {
    ...
    event
        .shaped(
            '2x ' + mi('polytetrafluoroethylene_machine_casing_pipe'),
            ['C C', 'CMC', 'C C'],
            {
    ...
    event
        .shaped(mi('tungstensteel_machine_casing'), ['PPP', 'PGP', 'PPP'], {
    ...
    event
        .shaped(
            '2x ' + mi('tungstensteel_machine_casing_pipe'),
            ['C C', 'CMC', 'C C'],
            {
    ...
    event
        .shaped(mi('photosynthetic_chamber'), ['MGM', 'IHI', 'PDT'], {
            G: '#c:glass_blocks',
    ...
    // -- CORE MINING DRILL -- //
    event
        .shaped(mi('core_drill'), ['MSM', 'CHC', 'SDS'], {
    ...
    // -- SINGULARITY FORGE -- //
    event
        .shaped(mi('singularity_forge'), ['PPP', 'CHC', 'PPP'], {
    ...
    // -- MOB CRUSHER -- //
    event
        .shaped(mi('mob_crusher'), ['RCR', 'PHP', 'MCM'], {
    ...
    event
        .shaped(mi('rocket_part_assembler'), ['RMR', 'GHG', 'APA'], {
            R: mi('robot_arm'),
            M: mi('advanced_motor'),
    ...
    event
        .shaped(mi('space_probe_launcher'), ['PUP', 'GHG', 'MCM'], {
    ...
    event
        .shaped(mi('quantum_space_probe_launcher'), ['PUP', 'GHG', 'MCM'], {
    ...
    event
        .shaped(mi('greenhouse'), ['MCM', 'RHR', 'PCP'], {
            M: mi('motor'),
            C: mi('analog_circuit'),
            H: mi('basic_machine_hull'),
            R: mi('tin_rotor'),
    ...
    // -- LASER ENGRAVER -- //
    event
        .shaped(mi('laser_engraver'), ['CGC', 'MHM', 'ACA'], {
            A: mi('analog_circuit'),
            C: mi('copper_wire'),
            H: mi('basic_machine_hull'),
            M: mi('motor'),
    ...
    event
        .shaped(mi('calorite_machine_casing'), ['PPP', 'PGP', 'PPP'], {
            P: mi('calorite_plate'),
            G: mi('calorite_gear'),
        })
    ...
    event
        .shaped(
            '2x ' + mi('calorite_machine_casing_pipe'),
            ['C C', 'CMC', 'C C'],
            {
    ...
    // -- DESH MACHINE CASING -- //
    event
        .shaped(mi('desh_machine_casing'), ['PPP', 'PGP', 'PPP'], {
            P: mi('desh_plate'),
            G: mi('desh_gear'),
        })
    ...
    event
        .shaped('2x ' + mi('desh_machine_casing_pipe'), ['C C', 'CMC', 'C C'], {
    ...
    event
        .shaped(mi('enderium_machine_casing'), ['PPP', 'PGP', 'PPP'], {
            P: mi('enderium_plate'),
            G: mi('enderium_gear'),
        })
    ...
    event
        .shaped(
            '2x ' + mi('ostrum_machine_casing_pipe'),
            ['C C', 'CMC', 'C C'],
            {
    ...
    // -- DESH DRILL -- //
    event
        .shaped('4x ' + mi('desh_drill'), ['GIH', 'MUI', 'CMG'], {
            G: mi('enderium_gear'),
            I: '#' + mi('item_pipes'),
    ...
    // ZINC DRILL //
    event
        .shaped('4x ' + mi('zinc_drill'), ['  H', 'GR ', 'BG '], {
    ...
    // -- BRONZE FURNACE -- //
    event
        .shaped(mi('bronze_furnace'), ['PPP', 'PCP', 'PFP'], {
            P: '#c:plates/bronze',
            F: mc('furnace'),
    ...
    // -- BRONZE BOILER -- //
    event
        .shaped(mi('bronze_boiler'), ['PTP', 'PCP', 'FFF'], {
            P: '#c:plates/bronze',
            T: mi('bronze_tank'),
    ...
    event
        .shapeless(mi('creative_tank'), mi('creative_tank'))
        .id(st('clear_fluids_from_creative_tank'));
    ...
    event
        .shaped(mi('stainless_steel_tank'), ['PPP', 'PGP', 'PPP'], {
    ...
    // -- TITANIUM TANK -- //
    event
        .shaped(mi('titanium_tank'), ['PPP', 'PGP', 'PPP'], {
            P: mi('titanium_plate'),
            G: kj('borosilicate_glass'),
        })
        .id(st('titanium_tank'));
    ...
    // -- TUNGSTENSTEEL TANK -- //
    event
        .shaped(mi('tungstensteel_tank'), ['PPP', 'PGP', 'PPP'], {
            P: mi('tungstensteel_plate'),
            G: kj('borosilicate_glass'),
        })
    ...
    event
        .shaped(mi('large_diesel_generator'), ['GMG', 'THT', 'GMG'], {
            M: mi('advanced_motor'),
            T: mi('titanium_gear'),
            H: mi('turbo_machine_hull'),
    ...
    // -- LARGE STEAM TURBINE -- //
    event
        .shaped(mi('large_steam_turbine'), ['GMG', 'RHR', 'GMG'], {
...
ServerEvents.tags('item', (event) => {
    ...
    ENERGY_OUTPUT_HATCH.forEach((id) => {
        event.add('kubejs:energy_output_hatch', id);
    });
    ...
    FLUID_INPUT_HATCH.forEach((id) => {
        event.add('kubejs:fluid_input_hatch', id);
    });
    ...
    FLUID_OUTPUT_HATCH.forEach((id) => {
        event.add('kubejs:fluid_output_hatch', id);
    });
    ...
    ITEM_INPUT_HATCH.forEach((id) => {
        event.add('kubejs:item_input_hatch', id);
    });
    ...
    ITEM_OUTPUT_HATCH.forEach((id) => {
        event.add('kubejs:item_output_hatch', id);
    });
    ...
    NUCLEAR_INPUT_HATCH.forEach((id) => {
        event.add('kubejs:nuclear_hatch', id);
    });
    ...
    NUCLEAR_FUEL.forEach((id) => {
        event.add('kubejs:nuclear_fuel', id);
    });
    ...
    DEPLETED_FUEL.forEach((id) => {
        event.add('kubejs:depleted_nuclear_fuel', id);
    });
