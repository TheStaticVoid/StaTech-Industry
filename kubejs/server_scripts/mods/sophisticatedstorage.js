...
ServerEvents.recipes((event) => {
    ...
    const SOPH_DELETED = [
        ...
        ss(
            'backpack_stack_upgrade_omega_tier_from_storage_stack_upgrade_omega_tier'
        ),
        ...
        ss(
            'backpack_advanced_compacting_upgrade_from_storage_advanced_compacting_upgrade'
        ),
        ss('magnet_upgrade'),
    ...
    event
        .shaped(ss('advanced_magnet_upgrade'), ['D', 'M'], {
            D: ss('magnet_upgrade'),
            M: sm('advancedmagnet'),
        })
    ...
    const storageContainers = ['chest', 'barrel', 'shulker_box'];
    ...
    const upgradeMaterials = ['copper', 'iron', 'gold', 'diamond'];
