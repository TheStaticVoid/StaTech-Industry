...
ServerEvents.recipes((event) => {
    ...
    // -- UPGRADE BASE -- //
    event
        .shaped(sb('upgrade_base'), ['SIS', 'ILI', 'SIS'], {
            S: mc('string'),
            I: '#c:plates/bronze',
            L: mc('leather'),
        })
    ...
    // -- FEEDING UPGRADE -- //
    event
        .shaped(sb('feeding_upgrade'), [' C ', 'GDM', ' F '], {
            C: mc('golden_carrot'),
            D: sb('upgrade_base'),
    ...
    event
        .shaped(sb('advanced_magnet_upgrade'), ['D', 'M'], {
            D: sb('magnet_upgrade'),
            M: sm('advancedmagnet'),
        })
    ...
    // -- TANK UPGRADE -- //
    event
        .shaped(sb('tank_upgrade'), [' T ', 'RDR', ' R '], {
            D: sb('upgrade_base'),
            T: mi('steel_tank'),
            R: mc('redstone'),
        })
