ServerEvents.recipes(e => {
    ...
    const saplingLogList = [    
        ...
        [ bg('purple_bulbis_oddity'),           bg('bulbis_stem'),              bg('purple_bulbis_shell'),              mi('molten_enderium') ],
        [ bg('bulbis_oddity'),                  bg('bulbis_stem'),              bg('bulbis_shell'),                     mi('molten_enderium') ],
        ...
        [ bg('fungal_imparius'),                bg('fungal_imparius_stem'),     bg('fungal_imparius_block'),            mi('molten_enderium') ],
        [ bg('imparius_mushroom'),              bg('imparius_stem'),            bg('imparius_mushroom_block'),          mi('molten_enderium') ],
        ...
        [ bg('nightshade_sapling'),             bg('nightshade_log'),           bg('nightshade_leaves'),                mi('molten_enderium') ],
        ...
        [ bg('shulkren_fungus'),                bg('white_mushroom_stem'),      bg('shulkren_wart_block'),              mi('molten_enderium') ],
