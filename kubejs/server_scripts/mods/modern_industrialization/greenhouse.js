...
ServerEvents.recipes((event) => {
    ...
    const saplingLogList = [
              // Sapling                    Log                          Leaves                         Fluid           Extra Drop
        Tree(mc('spruce_sapling'),       mc('spruce_log'),           mc('spruce_leaves'),           mc('water')),
    ...
    const spectrumSaplingList = [
        ...
        Tree(sp('slate_noxshroom'),      sp('slate_noxcap_stem'),    sp('slate_noxcap_gills'),      mc('water')),
        Tree(sp('ebony_noxshroom'),      sp('ebony_noxcap_stem'),    sp('ebony_noxcap_gills'),      mc('water')),
        Tree(sp('ivory_noxshroom'),      sp('ivory_noxcap_stem'),    sp('ivory_noxcap_gills'),      mc('water')),
        Tree(sp('chestnut_noxshroom'),   sp('chestnut_noxcap_stem'), sp('chestnut_noxcap_gills'),   mc('water')),
        Tree(sp('weeping_gala_sprig'),   sp('weeping_gala_log'),     sp('weeping_gala_leaves'),     mc('water'),     { item: sp('milky_resin'),  probability: 0.5  }),
    ];
    // prettier-ignore
