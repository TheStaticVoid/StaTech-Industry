...
LootJS.modifiers((event) => {
    ...
    // -- DUNGEON GARBAGE -- //
    event.addTableModifier('nomansland:chests/dungeon_garbage').pool((pool) => {
        pool.addEntry(
            LootEntry.reference('artifacts:inject/chests/simple_dungeon')
        );
    });
    ...
    // -- DUNGEON KITCHEN -- //
    event.addTableModifier('nomansland:chests/dungeon_kitchen').pool((pool) => {
        pool.addEntry(
            LootEntry.reference('artifacts:inject/chests/ancient_city_ice_box')
        );
    });

    // -- WATER WELL -- //
    event.addTableModifier('nomansland:chests/water_well').pool((pool) => {
        pool.addEntry(
    ...
    event
        ...
        .pool((pool) => {
            pool.addEntry(
                LootEntry.reference('artifacts:inject/chests/jungle_temple')
            );
        });
